function abrirEFecharPagina() {
    if (document.getElementById('idPersonagens').style.display == 'flex') {
        document.getElementById('idPagPag').style.backgroundColor = '#375610'
        ...
        //links Oficiais
        document.getElementById('idlinksOfi').style.backgroundColor = '#375610'
        ...
        //linguas
        document.getElementById('idOutrasLi').style.backgroundColor = '#375610'
