function abrirEFecharPagina() {
    if (document.getElementById('idPersonagens').style.display == 'flex') {
        document.getElementById('idPagPag').style.backgroundColor = '#860200'
        ...
        //links Oficiais
        document.getElementById('idlinksOfi').style.backgroundColor = '#860200'
        ...
        //linguas
        document.getElementById('idOutrasLi').style.backgroundColor = '#860200'
