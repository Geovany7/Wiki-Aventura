function abrirEFecharPagina() {
    if (document.getElementById('idPersonagens').style.display == 'flex') {
        document.getElementById('idPagPag').style.backgroundColor = '#FFD686'
        ...
        // pagina
        document.getElementById('idPagPag').style.backgroundColor = '#eecd8a'
        ...
        //links Oficiais
        document.getElementById('idlinksOfi').style.backgroundColor = '#FFD686'
        ...
        //linguas
        document.getElementById('idOutrasLi').style.backgroundColor = '#FFD686'
...
function abrirEFecharLinksOficiais() {
    if (document.getElementById('idSiteOficial').style.display == 'flex') {
        ...
        //links Oficiais
        document.getElementById('idlinksOfi').style.backgroundColor = '#eecd8a'
...
function abrirEFecharOutraslínguas() {
    if (document.getElementById('idEnglish').style.display == 'flex') {
        ...
        //linguas
        document.getElementById('idOutrasLi').style.backgroundColor = '#eecd8a'
